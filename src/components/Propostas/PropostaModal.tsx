...
export default function PropostaModal({ proposta, onClose }: PropostaModalProps) {
  ...
  return (
    <>
      {/* Modal overlay - oculto na impressão */}
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 print:hidden">
        <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          {/* Preview do conteúdo que será impresso */}
          <div className="p-8">
            <PropostaContent proposta={proposta} recursos={recursos} />
          </div>
        </div>
      </div>

      {/* Conteúdo para impressão - oculto na tela, visível apenas na impressão */}
      ...
      <style jsx global>{`
        @media print {
          ...
          /* Oculta tudo exceto o conteúdo da proposta */
          body > *:not(.hidden) {
          ...
          /* Espaçamentos adequados para impressão */
          .proposta-section {
...
// Componente separado para o conteúdo da proposta
function PropostaContent({ proposta, recursos }: { proposta: PropostaComercial; recursos: string[] }) {
  return (
    <div className="bg-white">
      ...
      {/* Dados do Cliente */}
      <div className="proposta-section page-break-avoid">
      ...
      {/* Recursos Incluídos */}
      <div className="proposta-section page-break-before">
